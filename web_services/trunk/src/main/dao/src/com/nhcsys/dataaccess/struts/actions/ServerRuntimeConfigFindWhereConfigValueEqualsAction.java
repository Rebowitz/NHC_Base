...
public class ServerRuntimeConfigFindWhereConfigValueEqualsAction extends NhcBaseAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward handle(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _configValue = request.getParameter("configValue");
		
			// create the DAO class
			ServerRuntimeConfigDao dao = ServerRuntimeConfigDaoFactory.create();
		
			// execute the finder
			ServerRuntimeConfig dto[] = dao.findWhereConfigValueEquals(_configValue);
