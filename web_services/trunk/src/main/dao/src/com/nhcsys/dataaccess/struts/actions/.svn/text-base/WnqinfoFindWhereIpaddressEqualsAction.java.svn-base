...
public class WnqinfoFindWhereIpaddressEqualsAction extends NhcBaseAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward handle(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _ipaddress = request.getParameter("ipaddress");
		
			// create the DAO class
			WnqinfoDao dao = WnqinfoDaoFactory.create();
		
			// execute the finder
			Wnqinfo dto[] = dao.findWhereIpaddressEquals(_ipaddress);
