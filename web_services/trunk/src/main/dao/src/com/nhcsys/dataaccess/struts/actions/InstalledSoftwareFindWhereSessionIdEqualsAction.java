...
public class InstalledSoftwareFindWhereSessionIdEqualsAction extends NhcBaseAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward handle(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _sessionId = request.getParameter("sessionId");
		
			// create the DAO class
			InstalledSoftwareDao dao = InstalledSoftwareDaoFactory.create();
		
			// execute the finder
			InstalledSoftware dto[] = dao.findWhereSessionIdEquals(_sessionId);
