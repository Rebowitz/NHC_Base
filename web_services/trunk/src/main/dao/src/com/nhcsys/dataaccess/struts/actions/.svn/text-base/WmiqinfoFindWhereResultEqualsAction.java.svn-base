...
public class WmiqinfoFindWhereResultEqualsAction extends NhcBaseAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward handle(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _result = request.getParameter("result");
		
			// create the DAO class
			WmiqinfoDao dao = WmiqinfoDaoFactory.create();
		
			// execute the finder
			Wmiqinfo dto[] = dao.findWhereResultEquals(_result);
