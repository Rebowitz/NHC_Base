...
public class InstalledSoftwareFindWhereProductKeyEqualsAction extends NhcBaseAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward handle(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _productKey = request.getParameter("productKey");
		
			// create the DAO class
			InstalledSoftwareDao dao = InstalledSoftwareDaoFactory.create();
		
			// execute the finder
			InstalledSoftware dto[] = dao.findWhereProductKeyEquals(_productKey);
