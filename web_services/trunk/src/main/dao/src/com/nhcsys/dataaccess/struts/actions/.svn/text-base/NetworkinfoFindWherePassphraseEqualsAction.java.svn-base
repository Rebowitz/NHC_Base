...
public class NetworkinfoFindWherePassphraseEqualsAction extends NhcBaseAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward handle(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _passphrase = request.getParameter("passphrase");
		
			// create the DAO class
			NetworkinfoDao dao = NetworkinfoDaoFactory.create();
		
			// execute the finder
			Networkinfo dto[] = dao.findWherePassphraseEquals(_passphrase);
