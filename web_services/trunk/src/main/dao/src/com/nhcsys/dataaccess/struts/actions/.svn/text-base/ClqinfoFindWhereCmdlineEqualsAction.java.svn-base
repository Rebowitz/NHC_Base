...
public class ClqinfoFindWhereCmdlineEqualsAction extends NhcBaseAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward handle(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _cmdline = request.getParameter("cmdline");
		
			// create the DAO class
			ClqinfoDao dao = ClqinfoDaoFactory.create();
		
			// execute the finder
			Clqinfo dto[] = dao.findWhereCmdlineEquals(_cmdline);
