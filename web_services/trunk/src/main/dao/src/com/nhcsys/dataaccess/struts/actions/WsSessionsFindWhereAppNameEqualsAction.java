...
public class WsSessionsFindWhereAppNameEqualsAction extends NhcBaseAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward handle(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _appName = request.getParameter("appName");
		
			// create the DAO class
			WsSessionsDao dao = WsSessionsDaoFactory.create();
		
			// execute the finder
			WsSessions dto[] = dao.findWhereAppNameEquals(_appName);
