...
public class TelesalesCallSourceFindWhereSourceDescEqualsAction extends NhcBaseAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward handle(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _sourceDesc = request.getParameter("sourceDesc");
		
			// create the DAO class
			TelesalesCallSourceDao dao = TelesalesCallSourceDaoFactory.create();
		
			// execute the finder
			TelesalesCallSource dto[] = dao.findWhereSourceDescEquals(_sourceDesc);
