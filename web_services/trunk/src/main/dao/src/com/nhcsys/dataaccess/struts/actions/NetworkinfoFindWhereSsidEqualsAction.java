...
public class NetworkinfoFindWhereSsidEqualsAction extends NhcBaseAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward handle(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _ssid = request.getParameter("ssid");
		
			// create the DAO class
			NetworkinfoDao dao = NetworkinfoDaoFactory.create();
		
			// execute the finder
			Networkinfo dto[] = dao.findWhereSsidEquals(_ssid);
