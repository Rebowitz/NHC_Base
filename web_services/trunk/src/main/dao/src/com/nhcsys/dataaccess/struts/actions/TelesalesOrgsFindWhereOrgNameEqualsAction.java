...
public class TelesalesOrgsFindWhereOrgNameEqualsAction extends NhcBaseAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward handle(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _orgName = request.getParameter("orgName");
		
			// create the DAO class
			TelesalesOrgsDao dao = TelesalesOrgsDaoFactory.create();
		
			// execute the finder
			TelesalesOrgs dto[] = dao.findWhereOrgNameEquals(_orgName);
