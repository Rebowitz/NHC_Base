...
public class UpdateStatusFindWhereDescriptionEqualsAction extends NhcBaseAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward handle(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _description = request.getParameter("description");
		
			// create the DAO class
			UpdateStatusDao dao = UpdateStatusDaoFactory.create();
		
			// execute the finder
			UpdateStatus dto[] = dao.findWhereDescriptionEquals(_description);
