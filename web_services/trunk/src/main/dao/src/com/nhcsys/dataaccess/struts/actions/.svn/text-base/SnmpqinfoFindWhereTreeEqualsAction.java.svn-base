...
public class SnmpqinfoFindWhereTreeEqualsAction extends NhcBaseAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward handle(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _tree = request.getParameter("tree");
		
			// create the DAO class
			SnmpqinfoDao dao = SnmpqinfoDaoFactory.create();
		
			// execute the finder
			Snmpqinfo dto[] = dao.findWhereTreeEquals(_tree);
