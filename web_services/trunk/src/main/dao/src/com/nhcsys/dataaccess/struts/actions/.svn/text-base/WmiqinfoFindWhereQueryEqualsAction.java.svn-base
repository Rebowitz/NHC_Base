...
public class WmiqinfoFindWhereQueryEqualsAction extends NhcBaseAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward handle(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _query = request.getParameter("query");
		
			// create the DAO class
			WmiqinfoDao dao = WmiqinfoDaoFactory.create();
		
			// execute the finder
			Wmiqinfo dto[] = dao.findWhereQueryEquals(_query);
