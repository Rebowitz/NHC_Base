...
public class WnqinfoFindWhereWnqscopeEqualsAction extends NhcBaseAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward handle(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _wnqscope = request.getParameter("wnqscope");
		
			// create the DAO class
			WnqinfoDao dao = WnqinfoDaoFactory.create();
		
			// execute the finder
			Wnqinfo dto[] = dao.findWhereWnqscopeEquals(_wnqscope);
