...
public class TelesalesRepsFindWherePasswordTextEqualsAction extends NhcBaseAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward handle(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _passwordText = request.getParameter("passwordText");
		
			// create the DAO class
			TelesalesRepsDao dao = TelesalesRepsDaoFactory.create();
		
			// execute the finder
			TelesalesReps dto[] = dao.findWherePasswordTextEquals(_passwordText);
