...
public class WnqinfoFindWhereRemotenameEqualsAction extends NhcBaseAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward handle(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _remotename = request.getParameter("remotename");
		
			// create the DAO class
			WnqinfoDao dao = WnqinfoDaoFactory.create();
		
			// execute the finder
			Wnqinfo dto[] = dao.findWhereRemotenameEquals(_remotename);
